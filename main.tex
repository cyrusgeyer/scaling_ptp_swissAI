...
\begin{figure}[H]
    ...
    \caption{Conceptual illustration: PTP targets the sequential decoding bottleneck by predicting multiple dependent tokens per model call \citep{draxler2026parallel}.}
\end{figure}
\vspace{-2mm}
